...
export default function UploadPage() {
  ...
  const handleVideoDurationChange = () => {
    // In a real application, you would use the video URL to calculate the duration
    // For this example, we'll just set a random duration between 60 and 600 seconds
