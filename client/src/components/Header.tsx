...
import { Menu, Search, Video, Bell, User, LogIn, LogOut, Settings } from 'lucide-react';
        ...
        <div className="flex items-center justify-between h-full">
          ...
          <div className="flex items-center">
            ...
            <Link href="/" className="flex items-center space-x-2">
              <span className="text-primary text-2xl font-bold">Vid<span className="text-foreground">Vault</span></span>
            </Link>
          </div>
          ...
          <div className="flex items-center space-x-4">
            ...
            {user ? (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Avatar className="cursor-pointer">
                    <AvatarImage src={user.avatar || DEFAULT_AVATAR} alt={user.displayName} />
                    <AvatarFallback>
                ...
                <DropdownMenuContent align="end">
                  ...
                  <DropdownMenuItem>
                    <span className="flex items-center" onClick={() => navigate('/settings')}>
              ...
              <Button onClick={handleLogin} variant="secondary" size="sm" className="flex items-center">
